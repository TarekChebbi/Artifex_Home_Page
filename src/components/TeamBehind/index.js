...
const TeamBehind = () => {
  ...
  <div class="card2-socials">
    <a href='https://www.facebook.com/dissojak' class="card2-socials-btn facebook">
      <svg
        data-name="Layer 21"
        height="24"
        id="Layer_21"
    ...
    <a href="https://github.com/dissojak" class="card2-socials-btn github" role="button">
  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24">
    ...
    <a href='https://www.linkedin.com/in/adembenamor/' class="card2-socials-btn linkedin">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="512"
        viewBox="0 0 512 512"
...
<div class="card2">
  ...
  <div class="card2-socials">
    <a href='https://www.facebook.com/tarek.chebbi.71/' class="card2-socials-btn facebook">
      <svg
        data-name="Layer 21"
        height="24"
        id="Layer_21"
    ...
    <a href='https://github.com/TarekChebbi' class="card2-socials-btn github">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="33"
        height="33"
    ...
    <a href='https://www.linkedin.com/in/tarek-chebbi/' class="card2-socials-btn linkedin">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="512"
        viewBox="0 0 512 512"
