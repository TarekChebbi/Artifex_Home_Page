  ...
  return (
    <div className="content">
        ...
        <div className="column1">
          ...
          <p>Premier destination for both art enthusiasts and creators alike. We boast an impressive array of exclusive collections, carefully curated to showcase the finest talents within the industry.Museums serves as a testament to the diversity and boundless creativity of our artists.</p>
        </div>
