      ...
      <div className="container-fluid position-relative">
        <Slider {...settings} className="home_slider_Main">
          <div className="item">
            ...
            <div className="info1">
              <h2 class="mb-4">
                Discover Art in Various
                <br />
                Categories on our <br />
                Marketplace
              </h2>
              <p>
                Browse through a wide selection of paintings, sculptures,
                digital art, and more on our marketplace.
              </p>{" "}
              <br />
              <p>
                {" "}
                Find the perfect piece to add to your collection or decorate
                your space.
              </p>
            </div>
          </div>
